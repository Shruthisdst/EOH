...
mysql_query("CREATE TABLE EOH (entry_id int(5) auto_increment, primary key(entry_id), word varchar(1000), text varchar(10000))auto_increment=10001 ENGINE=MyISAM character set utf8 collate utf8_general_ci");
$myXMLData ="eoh.xml";
